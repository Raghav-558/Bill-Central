            ...
            <div className='max-w-[1140px] mx-auto px-4 relative'>
                ...
                <div className='flex flex-wrap -mx-3 pt-[109px] max-lg:pt-[60px] max-md:pt-20 max-sm:pt-[60px]'>
                    <div className='w-1/2 px-3 max-lg:w-full max-lg:text-center'>
                        ...
                        <div className='pt-4 max-md:pt-3 max-w-[506px] max-md:max-w-[780px] text-white max-lg:max-w-[900px] max-lg:mx-auto'><Discription Para='Find and switch to the best energy, gas, and internet plans with ease. Our platform simplifies your search, letting you compare providers and make informed decisions, all in one place.' /></div>
