                ...
                <div className='flex flex-wrap -mx-3 pt-[109px] max-lg:pt-24 max-md:pt-20 max-sm:pt-12'>
                    <div className='w-1/2 px-3 max-lg:w-full max-lg:text-center flex justify-between flex-col '>
                        <div className=''>
                            ...
                            <form className='font-helvetica flex p-[9px] pl-[22px] bg-white rounded-[0px_100px_100px_100px] items-center max-w-[476px] justify-between max-sm:pl-3 max-lg:mx-auto max-sm:gap-1 mt-[42px] max-lg:mt-5'>
